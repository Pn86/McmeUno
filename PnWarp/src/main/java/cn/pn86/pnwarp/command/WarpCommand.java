    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (name) {
            case "addwarp" -> {
                ...
                player.sendMessage(warpService.msg("messages.add-success").replace("{warp}", warpName));
                return true;
            }
            case "remwarp" -> {
                if (!(sender instanceof Player player)) {
                ...
                player.sendMessage(success
                        ? warpService.msg("messages.rem-success").replace("{warp}", args[0])
        ...
        switch (sub) {
            ...
            case "remwarp" -> {
                ...
                sender.sendMessage(success
                        ? warpService.msg("messages.rem-success").replace("{warp}", args[1])
